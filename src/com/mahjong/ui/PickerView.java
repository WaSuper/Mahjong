...
public class PickerView extends View {
    ...
    private static class ScrollHandler extends Handler {
        ...
        private ScrollHandler(PickerView view) {
            mWeakView = new WeakReference<PickerView>(view);
        }
    ...
    private void initPaint() {
        ...
        mLightColor = mContext.getResources().getColor(R.color.date_picker_text_light);
        mDarkColor = mContext.getResources().getColor(R.color.date_picker_text_dark);
    }
