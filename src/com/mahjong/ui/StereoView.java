...
public class StereoView extends ViewGroup {
    ...
    private boolean isCanTouchRoll = true; // 是否能触摸滚动
    ...
    private static final int standerSpeed = 3000;
    ...
    public StereoView setCanTouchRoll(boolean canTouchRoll) {
    	isCanTouchRoll = canTouchRoll;
    	return this;
    }
