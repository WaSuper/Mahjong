...
public class RoundMenuView extends View {
    ...
    private RoundMenu mCurRoundMenu;
        ...
        if (roundMenus != null && roundMenus.size() > 0) {
            ...
            for (int i = 0; i < roundMenus.size(); i++) {
                ...
                if (onClickState == i) {
                    ...
                    //未选中
                	if (roundMenu.curItem) {
                		paint.setColor(roundMenu.curItemColor);
					} else {
            ...
            case MotionEvent.ACTION_UP:
                if ((new Date().getTime() - touchTime) < 300) {
                    ...
                    if (onClickState == -1) {
                    	...
                    	if (mCurRoundMenu != null) {
							mCurRoundMenu.curItem = false;
						}
                    	mCurRoundMenu = roundMenus.get(onClickState);
                    	mCurRoundMenu.curItem = true;
                        onClickListener = mCurRoundMenu.onClickListener;
                    }
     ...
     * @return roundMenu
     */
    public RoundMenu getCurRoundMenu() {
    	return mCurRoundMenu;
    }
     ...
     * @param menu
     */
    public void setCurRoundMenu(RoundMenu menu) {
    	if (mCurRoundMenu != null) {
			mCurRoundMenu.curItem = false;
		}
    	mCurRoundMenu = menu;
    ...
    public void setCoreMenu(int coreMenuColor, int coreMenuSelectColor, int coreMenuStrokeColor,
                            int coreMenuStrokeSize, double radiusDistance, Bitmap bitmap, 
    ...
    public static class RoundMenu {
        ...
        public boolean curItem = false;
        public int curItemColor = Color.parseColor("#be353d");
    }
}
