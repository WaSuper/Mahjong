...
public class RippleButton extends View {
    ...
    public RippleButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RippleButton);
        bgPressed = ta.getDrawable(R.styleable.RippleButton_pressed);
        bgNormal = ta.getDrawable(R.styleable.RippleButton_normal);
        ta.recycle();
        init();
    }
        ...
        rippleAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (iRippleAnimListener != null) {
                    iRippleAnimListener.onComplete(RippleButton.this);
                }
            }
