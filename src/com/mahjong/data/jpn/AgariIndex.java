...
//		                System.out.println("順子=" + value);
    ...
    private static int[] analyse(List<Tile> tiles) {
        int[] n = n_zero.clone();
     ...
     * @param tbl
     */
    private static void init5(TreeMap<Integer, int[]> tbl) {
    	tbl.put(0x5555557, new int[] {0x80000000});
    	tbl.put(0x555555d, new int[] {0x80000000});
    	tbl.put(0x5555575, new int[] {0x80000000});
    	tbl.put(0x55555d5, new int[] {0x80000000});
    	tbl.put(0x5555755, new int[] {0x80000000});
    	tbl.put(0x5555d55, new int[] {0x80000000});
    	tbl.put(0x5557555, new int[] {0x80000000});
    	tbl.put(0x555d555, new int[] {0x80000000});
    	tbl.put(0x5575555, new int[] {0x80000000});
    	tbl.put(0x55d5555, new int[] {0x80000000});
    	tbl.put(0x5755555, new int[] {0x80000000});
    	tbl.put(0x5d55555, new int[] {0x80000000});
    	tbl.put(0x7555555, new int[] {0x80000000});
    }
